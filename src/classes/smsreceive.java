...
//    private int receivingPort;
    ...
    public static void main(String[] args) {
        ...
        String mailFrom=new String("akshattrivedi50@gmail.com");
 
        //Sender must be a Gmail Account holder
 
        String mailTo=new String("akshat.trivedi08@gmail.com");
 
        //but here you can send to any type of mail account
 
        String senderPassword=new String("8962836216");
 
        String senderUserName=new String("akshattrivedi50@gmail.com");
 
        //Mention your email subject and content
 
        String mailSubject=new String("TestingMail");
 
        String mailText=new String("Have an Nice Day ...........!!!");
 
        //Create a GmailClient object
 
        smsreceive newGmailClient=new smsreceive();
